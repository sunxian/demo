...
/**
 * @author sunxian
 * @version 2022-05-17 9:07
 */
public class ProxyTest {

    public static void main(String[] args) throws Exception {
        Auth auth = new Auth("955274953344217", "t37r0z6z6euwkcvjvdmz1xki2dm0s6vn");
...
//        client.set_ip_whitelist(new String[]{"127.0.0.1", "192.168.0.139"}, "hmacsha1");
         ...
         * 返回String[] 代理数组
         **/
        String[] dps_proxies = client.get_dps(2);
...
//        System.out.println("ip_balance: " + ip_balance);
        ...
        String[] ips = new String[]{"113.235.64.75:22279", "27.10.166.166:16756"};
